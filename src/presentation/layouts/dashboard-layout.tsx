...
const DashboardLayout: Component = () => {
  return (
    <div class="flex h-full w-full flex-col gap-3 overflow-y-auto bg-[#0a0a1a] p-3 lg:grid lg:h-full lg:grid-cols-[260px_1fr_300px] lg:grid-rows-[1fr_140px] lg:gap-2 lg:overflow-hidden lg:p-2">
